...
def test_freshservice_connector():
    """Test the Freshservice connector using the shared LakeflowConnect test suite."""
    # Inject the Freshservice LakeflowConnect class into the shared test_suite namespace
    # so that LakeflowConnectTester can instantiate it.
    test_suite.LakeflowConnect = LakeflowConnect

    # Load connection-level configuration (e.g. api_key, domain)
